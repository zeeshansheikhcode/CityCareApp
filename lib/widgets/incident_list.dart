          ...
          title: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(incident.title, style:const TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
              ),

              Padding(
                padding: const EdgeInsets.only(top: 8.0),
                child: Text(incident.incidentDate, style:const TextStyle(fontStyle: FontStyle.italic, fontSize: 12, fontWeight: FontWeight.w400)),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 8.0),
